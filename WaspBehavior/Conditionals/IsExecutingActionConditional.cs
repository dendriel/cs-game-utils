...
{
	/// <summary>
	/// Conditional to check if the character is executing an action.
	/// </summary>
	public class IsExecutingActionConditional : Conditional
	{
		/// <summary>
		...
		bool IsExecutingActionTest()
		{
			return charDriver.IsExecutingAction();
		}
	}
} // namespace CSGameUtils