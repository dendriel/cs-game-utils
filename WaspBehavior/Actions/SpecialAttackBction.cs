...
{
	/// <summary>
	/// Execute the Special Attack B method from the given character.
	/// </summary>
	public class SpecialAttackBAction : AttackAAction
	{    
		/// <summary>
		/// Create a new SpecialAttackBAction.
		/// </summary>
		/// <param name="_charDriver">The driver of the character that will perform the attack.</param>
		public SpecialAttackBAction(ICharacterDriver _charDriver) : base(_charDriver)
		{}
    
		protected override BehaviorReturnCode AttackAExec()
		{
			charDriver.SpecialAttackB();
