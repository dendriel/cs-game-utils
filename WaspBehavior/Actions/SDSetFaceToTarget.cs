...
namespace CSGameUtils
{
	...
	public class SDSetFaceToTarget : BehaviorAction
	{
		...
		public SDSetFaceToTarget(ICharacterDriver _charDriver, Func<GameObject> _GetTargetFunc, bool _reverse = false)
		{
		...
		protected virtual BehaviorReturnCode SDSetFaceToTargetExec()
		{
			...
			float targetX = GetTargetFunc().transform.position.x;
